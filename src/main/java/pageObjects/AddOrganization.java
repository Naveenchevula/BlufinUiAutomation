...
public class AddOrganization extends LogIn {
	WebDriver driver;
	LogIn login;

	String os = null;
	static final Logger logger = LogManager.getLogger(AddOrganization.class.getName());
	...
	public void addOrg() throws Throwable {
		logger.info("# # # # # # # # # # # # # # # # # # # # # # # # # # # ");
		logger.info("# # # # # # # # VERIFICATION OF ADD ORGANIZATION # # # # # # # # # ");
		LogIn log = new LogIn();
		log.LoginFuction();
	...
	public void organizationForm(String OrgName, String OrgPhoneNumber, String Addresss, String email,
		...
		logger.info("# # # # # # # # # # # # # # # # # # # # # # # # # # # ");
		logger.info("# # # # # # # # VERIFICATION OF SEARCH ORGANIZATION FUNCTIONALITY # # # # # # # # # ");
		...
		logger.info("Searching for company newly created  :::::: "+ OrgName );
		SearchBox.sendKeys(Keys.ENTER);
		logger.info("Entered Company name and cliking on enter");
		logger.info("able to see created organization");
		logger.info("Organization details :::::: "+ OrgName );
	}
	...
	public void AddOrganizationBO() throws Throwable {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
		AddOrganization addOrg = new AddOrganization();
		addOrg.addOrg();
		addOrg.organizationForm("Auto Org" + RandomStringUtils.randomAlphabetic(3),
				"99638036" + RandomStringUtils.randomNumeric(2), "Auto Org" + RandomStringUtils.randomAlphabetic(3),
				"auto" + RandomStringUtils.randomAlphabetic(3).toLowerCase() + "@mailinator.com",
				"Auto Org" + RandomStringUtils.randomAlphabetic(3), "99638036" + RandomStringUtils.randomNumeric(2));
