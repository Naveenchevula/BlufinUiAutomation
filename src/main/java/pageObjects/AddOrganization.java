...
public class AddOrganization extends LogIn {
	...
	public AddOrganization(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void organizationForm(String OrgName, String OrgPhoneNumber, String Addresss, String email,
		...
		logger.info("# # # # # # # # # # # # # # # # # # # # # # # # # # # ");
		logger.info("# # # # # # # # VERIFICATION OF ADD ORGANIZATION FUNCTIONALITY # # # # # # # # # ");
	...
	/*	SelectImg.click();
		...
		driver.findElement(By.xpath("//body[1]/ng-component[1]/div[1]/div[3]/div[2]/ng-component[1]/div[2]/div[3]/div[1]/div[2]/div[1]/phone-country[1]/div[1]/p-dropdown[1]/div[1]/span[1]")).click();
		logger.info("clicked on Select Country");
		driver.findElement(By.xpath("//body[1]/ng-component[1]/div[1]/div[3]/div[2]/ng-component[1]/div[2]/div[3]/div[1]/div[2]/div[1]/phone-country[1]/div[1]/p-dropdown[1]/div[1]/div[3]/div[1]/ul[1]/cdk-virtual-scroll-viewport[1]/div[1]/p-dropdownitem[4]/li[1]/div[1]")).click();
		/*
		 * org name 
		 * String org = OrgNameFiled.getText();
		 */
		logger.info("Selected Country");
